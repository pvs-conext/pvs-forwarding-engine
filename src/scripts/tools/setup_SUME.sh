...
if [[ "$confirm" =~ ^([yY][eE][sS]|[yY])+$ ]]; then
  ...
  sudo apt-get install -y libfontconfig1:i386 libx11-6:i386 libxext6:i386 libxrender1:i386 libsm6:i386 libqtgui4:i386
  sudo apt-get install -y gcc g++ minicom  libusb-dev  libc6-i386  python-serial python-wxgtk3.0 lib32z1
  sudo apt-get install -y lib32z1 lib32ncurses5 libbz2-1.0 lib64z1 libc6-amd64:i386 lib64ncurses5 libncurses5-dev libbz2-1.0 lib32stdc++6 libc6-i386 lib32gcc1
  ...
  sudo apt-get install -y python-matplotlib python-pip libc6-dev-i386 google-perftools libboost-signals-dev libstdc++6 libboost-all-dev
  # sudo apt-get install -y libc6:i386 libncurses5:i386 libstdc++6:i386 libz-dev:i386
