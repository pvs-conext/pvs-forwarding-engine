...
//    assign dma_q_size = 'd16;
    ...
    //
    //
    // // vS Array (Virtual Switch 6)
    //   nf_sdnet_vSwitch6_ip
    // sdnet_vSwitch6  (
    //   .axis_aclk(axis_aclk),
    //   .axis_resetn(axis_resetn),
    //   // Master from vS to IvSI
    //   .m_axis_tdata (m_axis_vS6_tdata),
    //   .m_axis_tkeep (m_axis_vS6_tkeep),
    //   .m_axis_tuser (m_axis_vS6_tuser),
    //   .m_axis_tvalid(m_axis_vS6_tvalid),
    //   .m_axis_tready(m_axis_vS6_tready),
    //   .m_axis_tlast (m_axis_vS6_tlast),
    //   // Slave from IvSI to vS
    //   .s_axis_tdata (s_axis_vS6_tdata),
    //   .s_axis_tkeep (s_axis_vS6_tkeep),
    //   .s_axis_tuser ({dma_q_size,
    //                   nf3_q_size,
    //                   nf2_q_size,
    //                   nf1_q_size,
    //                   nf0_q_size,
    //                   s_axis_vS6_tuser[C_M_AXIS_TUSER_WIDTH-DIGEST_WIDTH-1:0]}),
    //   .s_axis_tvalid(s_axis_vS6_tvalid),
    //   .s_axis_tready(s_axis_vS6_tready),
    //   .s_axis_tlast (s_axis_vS6_tlast),
    //   // Slave from CvSI to vS
    //   .S_AXI_AWADDR(S_AXI_vS6_AWADDR),
    //   .S_AXI_AWVALID(S_AXI_vS6_AWVALID),
    //   .S_AXI_WDATA(S_AXI_vS6_WDATA),
    //   .S_AXI_WSTRB(S_AXI_vS6_WSTRB),
    //   .S_AXI_WVALID(S_AXI_vS6_WVALID),
    //   .S_AXI_BREADY(S_AXI_vS6_BREADY),
    //   .S_AXI_ARADDR(S_AXI_vS6_ARADDR),
    //   .S_AXI_ARVALID(S_AXI_vS6_ARVALID),
    //   .S_AXI_RREADY(S_AXI_vS6_RREADY),
    //   .S_AXI_ARREADY(S_AXI_vS6_ARREADY),
    //   .S_AXI_RDATA(S_AXI_vS6_RDATA),
    //   .S_AXI_RRESP(S_AXI_vS6_RRESP),
    //   .S_AXI_RVALID(S_AXI_vS6_RVALID),
    //   .S_AXI_WREADY(S_AXI_vS6_WREADY),
    //   .S_AXI_BRESP(S_AXI_vS6_BRESP),
    //   .S_AXI_BVALID(S_AXI_vS6_BVALID),
    //   .S_AXI_AWREADY(S_AXI_vS6_AWREADY),
    //   .S_AXI_ACLK (axi_aclk),
    //   .S_AXI_ARESETN(axi_resetn)
    // );
    //
    //
    // // vS Array (Virtual Switch 7)
    //   nf_sdnet_vSwitch7_ip
    // sdnet_vSwitch7  (
    //   .axis_aclk(axis_aclk),
    //   .axis_resetn(axis_resetn),
    //   // Master from vS to IvSI
    //   .m_axis_tdata (m_axis_vS7_tdata),
    //   .m_axis_tkeep (m_axis_vS7_tkeep),
    //   .m_axis_tuser (m_axis_vS7_tuser),
    //   .m_axis_tvalid(m_axis_vS7_tvalid),
    //   .m_axis_tready(m_axis_vS7_tready),
    //   .m_axis_tlast (m_axis_vS7_tlast),
    //   // Slave from IvSI to vS
    //   .s_axis_tdata (s_axis_vS7_tdata),
    //   .s_axis_tkeep (s_axis_vS7_tkeep),
    //   .s_axis_tuser ({dma_q_size,
    //                   nf3_q_size,
    //                   nf2_q_size,
    //                   nf1_q_size,
    //                   nf0_q_size,
    //                   s_axis_vS7_tuser[C_M_AXIS_TUSER_WIDTH-DIGEST_WIDTH-1:0]}),
    //   .s_axis_tvalid(s_axis_vS7_tvalid),
    //   .s_axis_tready(s_axis_vS7_tready),
    //   .s_axis_tlast (s_axis_vS7_tlast),
    //   // Slave from CvSI to vS
    //   .S_AXI_AWADDR(S_AXI_vS7_AWADDR),
    //   .S_AXI_AWVALID(S_AXI_vS7_AWVALID),
    //   .S_AXI_WDATA(S_AXI_vS7_WDATA),
    //   .S_AXI_WSTRB(S_AXI_vS7_WSTRB),
    //   .S_AXI_WVALID(S_AXI_vS7_WVALID),
    //   .S_AXI_BREADY(S_AXI_vS7_BREADY),
    //   .S_AXI_ARADDR(S_AXI_vS7_ARADDR),
    //   .S_AXI_ARVALID(S_AXI_vS7_ARVALID),
    //   .S_AXI_RREADY(S_AXI_vS7_RREADY),
    //   .S_AXI_ARREADY(S_AXI_vS7_ARREADY),
    //   .S_AXI_RDATA(S_AXI_vS7_RDATA),
    //   .S_AXI_RRESP(S_AXI_vS7_RRESP),
    //   .S_AXI_RVALID(S_AXI_vS7_RVALID),
    //   .S_AXI_WREADY(S_AXI_vS7_WREADY),
    //   .S_AXI_BRESP(S_AXI_vS7_BRESP),
    //   .S_AXI_BVALID(S_AXI_vS7_BVALID),
    //   .S_AXI_AWREADY(S_AXI_vS7_AWREADY),
    //   .S_AXI_ACLK (axi_aclk),
    //   .S_AXI_ARESETN(axi_resetn)
    // );
