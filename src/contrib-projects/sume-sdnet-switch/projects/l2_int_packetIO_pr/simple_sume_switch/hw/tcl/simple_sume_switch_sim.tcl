...
read_verilog "$::env(NF_DESIGN_DIR)/hw/hdl/packet_out_shifter.v"
...
read_verilog "$::env(NF_DESIGN_DIR)/hw/hdl/packet_in_shifter.v"
...
add_wave_group packet_out_IvSI
add_wave $IvSI/packet_out/clk -into packet_out_IvSI
add_wave $IvSI/packet_out/resetn -into packet_out_IvSI
add_wave $IvSI/packet_out/m_axis_tdata -into packet_out_IvSI -color teal
add_wave $IvSI/packet_out/m_axis_tkeep -into packet_out_IvSI -color teal
add_wave $IvSI/packet_out/m_axis_tuser -into packet_out_IvSI -color teal
add_wave $IvSI/packet_out/m_axis_tlast -into packet_out_IvSI -color teal
add_wave $IvSI/packet_out/m_axis_tready -into packet_out_IvSI
add_wave $IvSI/packet_out/m_axis_tvalid -into packet_out_IvSI -color teal
add_wave $IvSI/packet_out/s_axis_tdata -into packet_out_IvSI -color gold
add_wave $IvSI/packet_out/s_axis_tkeep -into packet_out_IvSI -color gold
add_wave $IvSI/packet_out/s_axis_tuser -into packet_out_IvSI -color gold
add_wave $IvSI/packet_out/s_axis_tlast -into packet_out_IvSI -color gold
add_wave $IvSI/packet_out/s_axis_tready -into packet_out_IvSI
add_wave $IvSI/packet_out/s_axis_tvalid -into packet_out_IvSI -color gold
add_wave $IvSI/packet_out/clk -into packet_out_IvSI
add_wave $IvSI/packet_out/resetn -into packet_out_IvSI
add_wave $IvSI/packet_out/shifted_data -into packet_out_IvSI -color khaki
add_wave $IvSI/packet_out/vSwitch_id -into packet_out_IvSI -color aqua
add_wave $IvSI/packet_out/vSwitch_port -into packet_out_IvSI -color aqua
add_wave $IvSI/packet_out/vSwitch_metadata -into packet_out_IvSI -color aqua
add_wave $IvSI/packet_out/vSwitch_id_reg -into packet_out_IvSI -color aqua
add_wave $IvSI/packet_out/vSwitch_port_reg -into packet_out_IvSI -color aqua
add_wave $IvSI/packet_out/vSwitch_metadata_reg -into packet_out_IvSI -color aqua
add_wave $IvSI/packet_out/state -into packet_out_IvSI -color orange
add_wave $IvSI/packet_out/indbg_pkt_len -into packet_out_IvSI -color white -radix unsigned
add_wave $IvSI/packet_out/outdbg_pkt_len -into packet_out_IvSI -color white -radix unsigned
add_wave $IvSI/packet_out/indbg_src_port -into packet_out_IvSI -color blue -radix bin
add_wave $IvSI/packet_out/indbg_dst_port -into packet_out_IvSI -color purple -radix bin
# add_wave $IvSI/packet_out/indbg_send_dig -into packet_out_IvSI
# add_wave $IvSI/packet_out/indbg_drop -into packet_out_IvSI
add_wave $IvSI/packet_out/doing_shifth_right -into packet_out_IvSI -color maroon
add_wave $IvSI/packet_out/axis_tdata_next -into packet_out_IvSI -color teal
add_wave $IvSI/packet_out/axis_tkeep_next -into packet_out_IvSI -color teal
...
add_wave $OvSI/axis_tdata -into Internal_OvSI -color aqua
add_wave $OvSI/axis_tuser -into Internal_OvSI -color aqua
add_wave $OvSI/axis_tkeep -into Internal_OvSI -color aqua
add_wave $OvSI/axis_tvalid -into Internal_OvSI -color aqua
add_wave $OvSI/axis_tlast -into Internal_OvSI -color aqua
add_wave_group packet_in_OvSI
add_wave $OvSI/packet_in/clk -into packet_in_OvSI
add_wave $OvSI/packet_in/resetn -into packet_in_OvSI
add_wave $OvSI/packet_in/m_axis_tdata -into packet_in_OvSI -color teal
add_wave $OvSI/packet_in/m_axis_tkeep -into packet_in_OvSI -color teal
add_wave $OvSI/packet_in/m_axis_tuser -into packet_in_OvSI -color teal
add_wave $OvSI/packet_in/m_axis_tlast -into packet_in_OvSI -color teal
add_wave $OvSI/packet_in/m_axis_tready -into packet_in_OvSI
add_wave $OvSI/packet_in/m_axis_tvalid -into packet_in_OvSI -color teal
add_wave $OvSI/packet_in/s_axis_tdata -into packet_in_OvSI -color gold
add_wave $OvSI/packet_in/s_axis_tkeep -into packet_in_OvSI -color gold
add_wave $OvSI/packet_in/s_axis_tuser -into packet_in_OvSI -color gold
add_wave $OvSI/packet_in/s_axis_tlast -into packet_in_OvSI -color gold
add_wave $OvSI/packet_in/s_axis_tready -into packet_in_OvSI
add_wave $OvSI/packet_in/s_axis_tvalid -into packet_in_OvSI -color gold
add_wave $OvSI/packet_in/clk -into packet_in_OvSI
add_wave $OvSI/packet_in/resetn -into packet_in_OvSI
add_wave $OvSI/packet_in/shifted_data -into packet_in_OvSI -color khaki
add_wave $OvSI/packet_in/vSwitch_id -into packet_in_OvSI -color aqua
add_wave $OvSI/packet_in/vSwitch_port -into packet_in_OvSI -color aqua
add_wave $OvSI/packet_in/vSwitch_metadata -into packet_in_OvSI -color aqua
add_wave $OvSI/packet_in/state -into packet_in_OvSI -color orange
add_wave $OvSI/packet_in/indbg_pkt_len -into packet_in_OvSI -color white -radix unsigned
add_wave $OvSI/packet_in/outdbg_pkt_len -into packet_in_OvSI -color white -radix unsigned
add_wave $OvSI/packet_in/indbg_src_port -into packet_in_OvSI -color blue -radix bin
add_wave $OvSI/packet_in/indbg_dst_port -into packet_in_OvSI -color purple -radix bin
# add_wave $OvSI/packet_in/indbg_send_dig -into packet_in_OvSI
# add_wave $OvSI/packet_in/indbg_drop -into packet_in_OvSI
add_wave $OvSI/packet_in/doing_shifth_left -into packet_in_OvSI -color maroon
