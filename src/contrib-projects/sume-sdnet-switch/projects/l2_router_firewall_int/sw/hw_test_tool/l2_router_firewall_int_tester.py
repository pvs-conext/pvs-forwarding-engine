...
# the University of Cambridge Computer Laboratory under EPSRC INTERNET Project EP/H040836/1 and
...
IFACE_H = {0:"nf0", 1:"nf1", 2:"nf2", 3:"nf3"}
...
vlan_id_map = {"l2_switch":1, "router":2, "firewall":3, "int":4, "firewall1":1, "firewall2":2, "l2_switch1":1, "l2_switch2":2}             # map the vlans of parrallel switches
...
MAC_addr_S[0] = "08:11:11:11:11:08"
MAC_addr_S[1] = "08:22:22:22:22:08"
MAC_addr_S[2] = "08:33:33:33:33:08"
MAC_addr_S[3] = "08:44:44:44:44:08"
...
class SimpleTester(cmd.Cmd):
    ...
    def _make_INT_pkt(self, src_MAC, dst_MAC, vlan_id, icnt, max_hop, total_hop, instr_mask, data, size):
    ...
    def _make_packet(self, flow_size, src_host):
        ...
        if ( vswitch == "l2_switch" or vswitch == "l2_switch1" or vswitch == "l2_switch2" ):
            ...
            dst_MAC = MAC_addr_H[dst_host_map[src_host]]
            ins_cnt = 1
            pkt = self._make_INT_pkt(src_MAC, dst_MAC, vlan_id, ins_cnt, 10, 0, SWITCH_ID_MASK, [], flow_size)
        else:
