...
TABLE_NUM = 10          # total tables number
...
vlan_id_map = {"l2":1, "router":2, "firewall":3, "int":4}             # map the vlans of parrallel switches
...
MAC_addr_S = {}
MAC_addr_S[nf_id_map["nf0"]] = "08:11:11:11:11:08"
MAC_addr_S[nf_id_map["nf1"]] = "08:22:22:22:22:08"
MAC_addr_S[nf_id_map["nf2"]] = "08:33:33:33:33:08"
MAC_addr_S[nf_id_map["nf3"]] = "08:44:44:44:44:08"
...
for time in range(DEF_PKT_NUM):
    ...
    if ( vlan_id == vlan_id_map["l2"] ):
        ...
        dst_MAC = MAC_addr_H[dst_host_map[src_host]]
        pkt_exp = Ether(src=src_MAC, dst=dst_MAC) / Dot1Q(vlan=vlan_id, prio=vlan_prio) / IP(src=src_IP, dst=dst_IP, ttl=64, chksum=0x7ce7) / UDP(sport=sport, dport=dport) / ((DEF_PKT_SIZE - HEADER_SIZE)*"A")
        extra_len = 0
