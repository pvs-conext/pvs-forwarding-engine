...
create_pblock vSwitch0
add_cells_to_pblock [get_pblocks vSwitch0] [get_cells -quiet [list nf_datapath_0/sdnet_vSwitch0]]
resize_pblock [get_pblocks vSwitch0] -add {SLICE_X62Y62:SLICE_X167Y196}
resize_pblock [get_pblocks vSwitch0] -add {DSP48_X4Y26:DSP48_X14Y77}
resize_pblock [get_pblocks vSwitch0] -add {RAMB18_X5Y26:RAMB18_X10Y77}
resize_pblock [get_pblocks vSwitch0] -add {RAMB36_X5Y13:RAMB36_X10Y38}
set_property RESET_AFTER_RECONFIG true [get_pblocks vSwitch0]
set_property SNAPPING_MODE ON [get_pblocks vSwitch0]
create_pblock vSwitch1
add_cells_to_pblock [get_pblocks vSwitch1] [get_cells -quiet [list nf_datapath_0/sdnet_vSwitch1]]
resize_pblock [get_pblocks vSwitch1] -add {SLICE_X52Y305:SLICE_X167Y450}
resize_pblock [get_pblocks vSwitch1] -add {DSP48_X3Y122:DSP48_X14Y179}
resize_pblock [get_pblocks vSwitch1] -add {RAMB18_X4Y122:RAMB18_X10Y179}
resize_pblock [get_pblocks vSwitch1] -add {RAMB36_X4Y61:RAMB36_X10Y89}
set_property RESET_AFTER_RECONFIG true [get_pblocks vSwitch1]
set_property SNAPPING_MODE ON [get_pblocks vSwitch1]
