...
dma2_applied = try_read_pkts(proj_dir + '/testdata/dma2_applied.pcap')
...
dma3_expected = try_read_pkts(proj_dir + '/testdata/dma3_expected.pcap')
dma0_expected = try_read_pkts(proj_dir + '/testdata/dma0_expected.pcap')# Import dummy dma0 pcap to get PASS in SUME simulation

# NOTE: ports are one-hot encoded
nf_port_map = {'nf0':0b00000001, 'nf1':0b00000100, 'nf2':0b00010000, 'nf3':0b01000000, 'dma_nf2':0b00100000}
...
schedule_pkts(dma2_applied, 'dma_nf2')
...
nftest_send_dma('nf2', dma2_applied)
...
nftest_expect_dma('nf0', dma0_expected) # Expected dummy dma0 pcap to get PASS in SUME simulation
