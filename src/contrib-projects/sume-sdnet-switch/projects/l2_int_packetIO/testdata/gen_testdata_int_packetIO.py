...
IP_addr = {}
IP_addr["nf0"] = "10.1.1.1"
IP_addr["nf1"] = "10.2.2.2."
IP_addr["nf2"] = "10.3.3.3."
IP_addr["nf3"] = "10.4.4.4."
...
def make_INT_pkt(ingress, egress, icnt, max_hop, total_hop, instr_mask, data, size):
    pkt = Ether(dst=MAC_addr[egress], src=MAC_addr[ingress]) / Dot1Q(vlan=VLAN_ID) / \
...
pkt_out = make_INT_pkt(ingress, egress, ins_cnt, 10, 1, SWITCH_ID_MASK,[SWITCH_ID], len(pkt_in)+extra_len)
