...
class SimpleSumeSwitch(cmd.Cmd):
    ...
    prompt = ">> "
    intro = "The "+ os.environ["PVS_VSWITCH"] +" interactive command line tool\n type help to see all commands"
    ...
    def help_list_regs(self):
        print """
list_regs
DESCRIPTION: List the registers defined in the """+ os.environ["PVS_VSWITCH"] +""" and their relevant compile time information
"""
...
"""
    ...
    def help_list_cam_tables(self):
        print """
list_cam_tables
DESCRIPTION: List the exact match tables defined in the """+ os.environ["PVS_VSWITCH"] +""" and their relevant compile time information
"""
...
"""
    ...
    def help_list_tcam_tables(self):
        print """
list_tcam_tables
DESCRIPTION: List the ternary match tables defined in the """+ os.environ["PVS_VSWITCH"] +""" and their relevant compile time information
"""
...
"""
    ...
    def help_list_lpm_tables(self):
        print """
list_lpm_tables
DESCRIPTION: List the longest prefix match tables defined in the """+ os.environ["PVS_VSWITCH"] +""" and their relevant compile time information
"""
