...
vlan_id_map = {"l2_switch":1,"l2_switch0":1,"l2_switch1":2, "router":2,"router0":1,"router1":2}             # map the vlans of parrallel switches

port_slicing = {}                                     # map the slicing of ports of SUME nf[0, 1, 2, 3] based in network topology
port_slicing[0] = "l2_switch0"
port_slicing[1] = "l2_switch0"
port_slicing[2] = "router1"
port_slicing[3] = "router1"
...
class SimpleTester(cmd.Cmd):
    ...
    prompt = "> "
    intro = "\nThe HW testing tool for the virtual switches l2 and router \n\tType help to see all commands\n"
    ...
    def _make_packet(self, flow_size, src_host):
        ...
        if ( vswitch == "l2_switch" or vswitch == "l2_switch0" or vswitch == "l2_switch1" ):
        ...
        elif( vswitch == "router" or vswitch == "router0" or vswitch == "router1" ):
            src_MAC = MAC_addr_H[src_host]
